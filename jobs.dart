...
import 'package:testing_senuris_one/components/BottomNavBar.dart';
import 'package:testing_senuris_one/pages/ADJobs.dart';
import 'package:testing_senuris_one/pages/editJob.dart';
import 'package:testing_senuris_one/pages/job_details.dart'; // Import your JobDetails page here
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) => JobDetailsPage(
                            ...
                            companyLogo:
                                job['companyLogo'] ??
                                'https://defaultLogoURL.com',
                            jobDescription:
                                job['jobDescription'] ?? 'No Description',
                            jobPosition:
                                job['jobPosition'] ?? 'No Job Position',
                            jobType: job['jobType'] ?? 'No Job Type',
